#ifndef DSPIC33AK_I2C_MASTER_H
#define DSPIC33AK_I2C_MASTER_H
...
/*
 * dsPIC33AK I2C master driver interface.
 *
 * Include this header to use the I2C peripheral as a bus master. The shared
 * instance / status types live in dspic33ak_i2c.h (included above); the slave
 * role is in dspic33ak_i2c_slave.h. A program may include either or both.
 *
 * Design policy:
